        ...
        return (
            ...
            <div className="container" id="home">
                ...
                >
                    ...
                    <p style={{ padding: '-50%' }}> Motion Designer and Web Animator</p>
                    ...
                    <p className="intro-text" style={{ marginTop: '0%' }}>
                        Hi, I'm Taylor Tyson and I am a digital storyteller.
                        I am always looking for the next big thing in data viz. I am currently working as a graphics fellow at <a href="https://www.insider.com/">Insider</a>.
                        Most of the time, you can find me at your local coffee shop working on anything ranging from scroll animation, 3D modeling to data viz.
                    ...
                    <div className=" scroll-suggestion" style={{ paddingBottom: '5%' }}>
                        <Tooltip label="Scroll" position="bottom">
