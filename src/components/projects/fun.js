                ...
                <Grid className="side-page-content project-content" style={{
                    ...
                    <Cell col={10} offset={1} tablet={8} offsetTablet={2} phone={8} offsetPhone={2}>
                        ...
                        <p className="project-role animated fadeInUp delay-1s">
                            In my free time, I love to do a variety of personal projects, and have dabbled in other modes of storytelling.
                            Initially interested in video, I created a variety of quick videos alongside friends.
                            Here are a few of the more notable things I have worked on!
                </p>
                    </Cell>
