                ...
                <Grid className="side-page-content project-content" style={{
                    ...
                    <Cell col={10} offset={1} tablet={8} offsetTablet={2} phone={8} offsetPhone={2}>
                        ...
                        <p className="project-role animated fadeInUp delay-1s" >
                            ...
                            This video is used internally at the School of Medicine to inform prospective students and staff of the learning initiative. The explainer video was accompanied by a Keynote presentation, focusing on more in-depth information about the initiative.
                            As a team, we really wanted to create a design that was accessible, informative and universal by stepping out of the traditional UNC branding.
        </p>
                    </Cell>
